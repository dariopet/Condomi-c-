...
function calcularRetenido(porcentaje, limite) {
    if ($('#pagar').prop("checked")) {
        ...
        var limiteDisponible: number;
        var yaRetenido: number;
        var yaRetenidoConcepto: number;
        var monto: number;
        var yaPagadoEsteConcepto: number;
        var yaPagadoFactura: number;
        var retenidoOriginal: number;
